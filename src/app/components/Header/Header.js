              ...
              link.href === "/page/contactme" ? (
                ...
                <li key={link.href} className="ml-auto">
                  <Link
                    ...
                    className="text-xl font-bold bg-[#223740] hover:bg-[#48AFDE] text-white px-6 py-3 rounded-xl transition-colors duration-300 shadow-lg"
                  >
                    {link.label}
                  </Link>
                </li>
                ...
                <li key={link.href} className="group text-2xl relative font-bold mr-14">
                  ...
                  <Link
                    className={`menu-item ${
                      selectedIndex1 === index ? "text-black" : "text-[#47626D]"
